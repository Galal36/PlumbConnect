...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'status', 'image', 'is_online', 'last_seen'
        ]
        extra_kwargs = {
            ...
            'is_online': {'read_only': True}, # Online status is managed by system
            'last_seen': {'read_only': True}, # Last seen is managed by system
